...
JEFRi.Runtime = function(contextUri, options, protos) {
    ...
    _(definition.Constructor.prototype).extend(EventDispatcher.prototype, {
      ...
      _destroy: _.lock(function() {
        ...
        for (rel_name in definition.relationships) {
          if ((_ref = this[rel_name]) != null) {
            _ref.remove.call(this);
          }
        }
        ec.destroy(this);
  ...
  _build_mutacc = function(definition, field, property) {
    ...
    return _(definition.Constructor.prototype[field]).extend({
      set: function(value) {
  ...
  _build_relationship = function(definition, field, relationship) {
    ...
    if ("has_many" === relationship.type) {
      _(definition.Constructor.prototype[field]).extend({
        get: function() {
          var id, type, _ref;
        ...
        add: function() {
          ...
          for (_i = 0, _len = relations.length; _i < _len; _i++) {
            entity = relations[_i];
            if (!_(this._relationships[field]).find(_.bind(JEFRi.EntityComparator, null, entity))) {
        ...
        remove: function(related) {
          this._relationships[field] = _(this._relationships[field]).reject(function(it) {
            return related._compare(it);
          });
          return this;
        }
      });
      ...
      _(definition.Constructor.prototype[field]).extend({
        ...
        remove: _.lock(function() {
          var _ref;
          if ("is_a" !== relationship.type) {
            if (relationship.back) {
              if ((_ref = this._relationships[field]) != null) {
                _ref[relationship.back].remove.call(this._relationships[field], this);
              }
            }
          }
