...
Request = (function() {
  ...
  ajax = function(options) {
    ...
    xhr.open(options.type || (options.data ? "POST" : "GET"), options.uri, true);
...
JEFRi.Runtime = function(contextUri, options, protos) {
  ...
  _build_prototype = function(type, definition, proto) {
    ...
    _(definition.Constructor.prototype).extend(JEFRi.EventDispatcher.prototype, {
      _type: function(full) {
        full = full || false;
        return type;
      },
...
JEFRi.EventDispatcher = function() {};

JEFRi.EventDispatcher.prototype = {
